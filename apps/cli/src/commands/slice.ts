...
function bookingMetricsTable(analysis: SliceAnalysis): string[] {
  ...
  const rows: Array<[string, string, string]> = [
    ...
    ["Programs with one sole dominant", String(metrics.programsWithSoleDominant), BOOKING_METRIC_DESCRIPTIONS.programsWithSoleDominant],
    ["Television match beats", String(metrics.televisionMatchBeats), BOOKING_METRIC_DESCRIPTIONS.televisionMatchBeats],
    ["Outside beat participants", String(metrics.outsideBeatParticipants), BOOKING_METRIC_DESCRIPTIONS.outsideBeatParticipants],
    ["TV main events that are matches", `${metrics.televisionMatchMainEvents.matches}/${metrics.televisionMatchMainEvents.total} (${percent(metrics.televisionMatchMainEvents.share)})`, BOOKING_METRIC_DESCRIPTIONS.televisionMatchMainEvents],
    ["Repeated card placements", String(metrics.repeatedPlacements), BOOKING_METRIC_DESCRIPTIONS.repeatedPlacements],
    ["Score inversions", String(metrics.scoreInversions), BOOKING_METRIC_DESCRIPTIONS.scoreInversions],
    ["Programs by objective", tokenCounts(metrics.programsByObjective), BOOKING_METRIC_DESCRIPTIONS.programsByObjective],
