...
Commands:
  ...
  slice [--scenario <id>] [--seeds N] [--weeks N] [--report <path>] [--json <path>]
                                                        run slice validation; saves an HTML report and, with --json,
                                                        a machine-diffable dump of every per-seed analysis`;
