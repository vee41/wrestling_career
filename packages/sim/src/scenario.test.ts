...
const scenario = scenarioSchema.parse({
  ...
  roster: [
    { wrestler: { id: "alpha", name: "Alpha", skills: { ringPerformance: 70, psychology: 70, promoAbility: 70, characterWork: 70, athleticism: 70, toughness: 70, professionalism: 70, politicalInstinct: 70 }, condition: 90, money: 1000, alignment: "face", gimmick: { concept: "Hero", promoTone: "earnest", traits: ["brave"], presentation: "simple gear", currentDirection: "rising" } }, popularity: { wrestlerId: "alpha", currentReaction: 60, generalPopularity: 60, momentum: 2, positiveHeat: 60, negativeHeat: 0, fatigue: 0 }, stance: "pursue_championships" },
